...
public class TapTarget {
    ...
    int id = -1;
    boolean drawOuterCircleShadow = false;
    boolean drawCardShadow = false;
    boolean cancelable = true;
    boolean tintTarget = true;
    boolean transparentTarget = false;
    float descriptionTextAlpha = 0.54f;
    int revealAnimationDuration = 250;
    int pulseAnimationDuration = 1000;
    ...
    @Override public boolean equals(final Object obj) {
        if (!TapTarget.class.isInstance(obj)) {
            return false;
        }
        if (this == obj) {
            return true;
        }
        if (((TapTarget) obj).id != -1) {
            return ((TapTarget) obj).id == this.id;
        }
    ...
    /**
     * Specify whether or not to draw a drop shadow around the outer circle & card
     **/
    public TapTarget drawShadow(boolean draw) {
        this.drawCardShadow = draw;
        this.drawOuterCircleShadow = draw;
        return this;
    }
    ...
    public TapTarget cardColor(@ColorRes final int cardColor) {
        this.cardColorRes = cardColor;
        return this;
    }

    public TapTarget cardColorInt(@ColorInt final int cardColor) {
        this.cardColor = cardColor;
        return this;
    }

    public TapTarget drawCardShadow(final boolean drawShadow) {
        this.drawCardShadow = drawShadow;
        return this;
    }

    public TapTarget drawOuterCircleShadow(final boolean drawShadow) {
        this.drawOuterCircleShadow = drawShadow;
        return this;
    }

    public TapTarget revealDuration(final int durationMillis) {
        this.revealAnimationDuration = durationMillis;
        return this;
    }

    public TapTarget pulseDuration(final int durationMillis) {
        this.pulseAnimationDuration = durationMillis;
        return this;
    }

    public TapTarget showDebugInfo(final boolean showDebug) {
    ...
    @Nullable
    Integer cardColorInt(Context context) {
        return colorResOrInt(context, cardColor, cardColorRes);
    }
